...
try {
  ...
  */
  ...
  $insertarUsuario = $con->prepare("UPDATE jugadores SET nombreJugador = '$nombre',  direccionJugador = '$direccion' WHERE emailUsuario = '$email'");
  $insertarUsuario->execute();

  //print_r($insertarUsuario);


  echo '<div class="alert alert-warning alert-dismissable" role="alert"><button type="button" class="close" data-dismiss="alert"></button>Se modificó el usuario correctamente</div>';
